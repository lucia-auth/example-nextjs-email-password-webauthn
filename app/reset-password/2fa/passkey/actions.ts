...
import { getCurrentPasswordResetSession, setPasswordResetSessionAs2FAVerified } from "@/lib/server/password-reset";
...
import { getUserPasskeyCredential, verifyWebAuthnChallenge } from "@/lib/server/webauthn";
